 ...
 * @var \App\Model\Entity\Informe[]|\Cake\Collection\CollectionInterface $informe
 */
?>
...
<div class="informe index large-9 medium-8 columns content">
    <h3><?= __('Informe') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('plantilla') ?></th>
